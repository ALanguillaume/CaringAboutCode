...
magick::image_read("images/sisyphus.png") %>%
...
```{r,echo = FALSE}
image_read("images/copyingandpasting-big.png") %>%
	image_resize("20%x20%")
```
...
```{r, echo = FALSE, fig.align = 'center'}
image_read("images/learning-diagram.png")
```
...
```{r, echo = FALSE, fig.align = 'center'}
image_read("images/torah_neg.jpg")
```
...
2. __Clear syntax__: Lay out ! Lay out ! Layout !
